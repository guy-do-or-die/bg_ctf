...
contract Solver12 {
    ...
    function step2(bytes memory rlp) external {
        ...
        // Check balance
        (bool success, bytes memory data) = nftAddr.staticcall(abi.encodeWithSignature("balanceOf(address)", address(this)));
        ...
        (success, ) = nftAddr.call(abi.encodeWithSignature("transferFrom(address,address,uint256)", address(this), tx.origin, 12));
